...
async def distribute(context: ContextTypes.DEFAULT_TYPE):
    ...
    for giver, recv in assignments.items():
        ...
        text = (
            ...
            "🧚 • напоминаю, что рекомендованный диапазон стоимости подарков – 500-1000 рублей\n"
            "👯‍♀ • обмен подарками произойдет в рамках новогоднего ЧГК 20-го декабря!\n"

            "Если возникнут вопросы по проведению или по подарку, смело пишите организаторам: @FloodyMary"            
        ).format(
