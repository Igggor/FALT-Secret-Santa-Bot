...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if uid in users:
        msg = (
            "Ой-ой! Кажется, вы уже были зарегистрированы на Тайного Санту ранее ✨🥰\n"
            "Не волнуйтесь, вы уже участвуете!\n\n"

            "Если вы допустили ошибку в введенных данных, хотите добавить пожелания или отказаться от участия, напишите нашим организаторам: @FloodyMary"
        )
...
async def help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message:
        ...
        text = (
            ...
            "Я бот, созданный для проведения тайного Санты для студентов ФАЛТ! ✈️\n"
            "Чтобы принять участие, регистрируйся, используя команду /start ✍\n\n"

            "Ответьте на несколько вопросов о себе и обязательно напишите о своих пожеланиях как можно подробнее, чтобы вашему тайному Санте было проще создать для вас небольшое новогоднее чудо ✨🧚\n\n"

            "6-го декабря мы проведем жеребьевку, на которой определим каждому участнику его тайного Санту. До этого времени даже после регистрации вы можете отказаться от участия, написав организаторам 🛟🕵‍♀\n\n"

            "Рекомендуем выбирать подарки в ценовом диапазоне 500-1000р, так никому не будет обидно, и все получат положительные эмоции от игры ✨🥰\n"
